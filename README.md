...
|---|---|---|
| [`github-actions-build`](github-actions-build/) | Run narrowly scoped remote compilation through a dedicated manual GitHub Actions workflow with allowlisted profiles and a history-based execution budget. | ChatGPT or another agent with a GitHub connector, Python 3.9+, GitHub Actions |
...
| [`github-workspace`](github-workspace/) | Materialize, refresh, archive, restore, and publish connector-backed local repository workspaces without giving Python GitHub credentials. | ChatGPT or another agent with a GitHub connector, Python 3.9+ |
